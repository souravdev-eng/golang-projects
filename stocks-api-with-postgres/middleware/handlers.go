...
func GetStock(w http.ResponseWriter, r *http.Request) {
	// 1. get the stockId from the request params, key is "id"
	params := mux.Vars(r)

	// 2. convert the id type from string to int
	...
	// 3. call the getStock function with stock id to retrieve a single stock
